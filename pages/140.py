...
class CurrencyPage(Page):
    ...
    def generate_content(self):
        ...
        currency_symbol_before = ['$',u"€",possible_symbols_before[random_rate1]]#,possible_symbols[random_rate2]]
        currency_symbol_after = ['','',possible_symbols_after[random_rate1]]#,possible_symbols[random_rate2]]
        ...
        content += self.colours.colour_print_join([
                        (printer.text_to_ascii("|",False)+"",
                            self.colours.Background.DEFAULT,
                            self.colours.Foreground.BLACK), 
                        (printer.text_to_ascii(currency_symbol_before[2] + currency_format[2].format(currency_rate[2]*currency_multiple[2]) + currency_symbol_after[2],False)+"",
                            self.colours.Background.WHITE,
