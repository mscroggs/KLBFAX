...
page1 = CountdownPage("120","Christmas",next(12, 25, 0, 0),"120-124")
page2 = CountdownPage("121","EMF2018",datetime(2018, 8, 31, 11, 0))
page3 = CountdownPage("122","EMF2020",datetime(2018, 8, 21, 11, 0))
...
page7 = CountdownPage("126","2019",datetime(2019, 1, 1, 0, 0))
page8 = CountdownPage("127","2020",datetime(2020, 1, 1, 0, 0))
